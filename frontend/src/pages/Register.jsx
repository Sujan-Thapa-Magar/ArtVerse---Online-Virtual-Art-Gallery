    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <nav className="flex items-center justify-between px-10 py-5 border-b border-gray-100">
        <div className="flex items-center gap-3">
          <button className="text-gray-600 text-lg bg-transparent border-none cursor-pointer">☰</button>
          <a href="/" className="font-serif italic text-2xl font-semibold text-gray-900 no-underline">
            ArtVerse
          </a>
        </div>
        <div className="hidden md:flex items-center gap-8">
          <a href="/exhibitions" className="text-xs tracking-widest text-gray-500 no-underline font-medium hover:text-gray-900">EXHIBITIONS</a>
          <a href="/artists" className="text-xs tracking-widest text-gray-500 no-underline font-medium hover:text-gray-900">ARTISTS</a>
          <a href="/archive" className="text-xs tracking-widest text-gray-500 no-underline font-medium hover:text-gray-900">ARCHIVE</a>
          <div className="w-9 h-9 rounded-full bg-gray-500 cursor-pointer" />
        </div>
      </nav>

      {/* Main */}
      <main className="max-w-md mx-auto px-6 py-12 pb-20">

        <h1 className="font-serif text-3xl font-normal text-center text-gray-900 mb-2">
          The Sacred Curator
        </h1>
        ...
        {activeTab === "register" ? (
          <form onSubmit={handleRegister}>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 bg-gray-900 text-white text-xs tracking-widest font-semibold rounded-md mb-4 hover:bg-gray-700 transition-colors disabled:opacity-60 cursor-pointer"
            >
          ...
          <form onSubmit={handleLogin}>
            ...
            <p className="text-center text-xs text-gray-400 mt-6">
              ...
              <span
                className="text-gray-900 underline cursor-pointer font-medium"
